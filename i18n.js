...
window.ASE_I18N = {
  ...
  tr: {
    ...
    built_quote: '"6 proje genelinde 34 alan adı yönetiyorum. ASE'yi bir hafta sonunda inşa ettim çünkü başka hiçbir şey her şeyi tek yerde göstermiyordu. Sonra büyüdü."',
  ...
  hi: {
    ...
    nav_alerts: 'अलर्ट',
    nav_demo: 'डेमो',
    hero_eyebrow: 'ASE से मिलें · डोमेन का रक्षक',
    hero_badge: 'v6.0',
    hero_title_1: 'आपकी वेबसाइटों का',
    hero_title_em: 'संदेशवाहक',
    hero_title_2: '',
    hero_subtitle: '<strong>अपटाइम। DNS। SSL। अलर्ट।</strong> ASE आपके हर डोमेन की रक्षा करता है — बिना सर्वर के, बिना किसी रुकावट के, एक देवता की गति से।',
    ...
    feat_eyebrow: 'ASE क्या करता है',
    feat_title_1: 'एक नज़र में,',
    feat_title_em: 'हर संकेत।',
    feat_subtitle: 'A रिकॉर्ड से DMARC नीतियों तक, SSL समाप्ति से अपटाइम इतिहास तक — ASE वह सब देखता है जो आपके डोमेन फुसफुसाते हैं, और चिल्लाने से पहले आपको बताता है।',
    ...
    how_step3_title: 'ASE संभाल लेता है',
    ...
    alert_subtitle: 'ASE प्रति घटना एक खूबसूरत डाइजेस्ट ईमेल भेजता है — कभी स्पैम नहीं। हर अलर्ट में पूरा डोमेन हेल्थ स्नैपशॉट होता है: SSL दिन, DMARC, SPF, NS, MX।',
    ...
    cta_btn_dl: '↓ v6.0.0 डाउनलोड करें',
    built_eyebrow: 'कैसे बनाया गया',
    built_quote: '"मैं 6 प्रोजेक्ट्स में 34 डोमेन मैनेज करता हूं। मैंने ASE एक वीकेंड में बनाया क्योंकि कोई और टूल सब कुछ एक जगह नहीं दिखाता था। और फिर यह बड़ा हो गया।"',
    built_story: 'ASE की शुरुआत "The All Seeing Eye" के रूप में हुई — एक व्यक्तिगत मॉनिटरिंग टूल। v1.0 से v5.0 तक हर संस्करण CHANGELOG में दर्ज है।',
    ...
    footer_copy: '© 2026 ase.so · MIT लाइसेंस',
  },
};
